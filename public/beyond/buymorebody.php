...
<?php }?>
                        ...
                        <div class="single-property-wrapper">
                            <div class="single-property-header">                                          
                                <h1 class="property-title pull-left"><br /><?php
...
if (isset($_SESSION['MM_Username'])) {?>
                                ...
                                <div class="col-sm-10 col-sm-offset-1">
                                    <div class="form-group">
                                        ...
                                        <input readonly required name="name" type="text" class="form-control" placeholder="Name" value="<?php echo $row_user['fname'];?>">
                                ...
                                <div class="col-sm-10 col-sm-offset-1">
                                    <div class="form-group">
                                        ...
                                        <input name="p-email" type="hidden" value="<?php echo $row_user['Email'];?>" class="form-control" placeholder="p-email@rmail.com">
...
if ($row_use['Username'] == $row_user['Email']) {?>
<div class="col-sm-10 col-sm-offset-1">
                                <br>
<h5>You cannot send a message to yourself</h5>
</div>
<?php } ?>
